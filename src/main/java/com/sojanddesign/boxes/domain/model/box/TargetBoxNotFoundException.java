 ...
 *
 */
public class TargetBoxNotFoundException extends DomainException {

	/**
	 * generated serial version UID
	 */
	private static final long serialVersionUID = 8420081126618372113L;

	/**
	 * 
	 */
	public TargetBoxNotFoundException() {
	 ...
	 * @param message
	 */
	public TargetBoxNotFoundException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public TargetBoxNotFoundException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public TargetBoxNotFoundException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
