...
/**
 * TODO NextActionsManagementPolicy
 * @author Marie Acevedo (http://www.sojanddesign.com)
 * @version 29 janv. 2013 - 0.1
 */
class NextActionsManagementPolicy extends AbstractBoxManagementPolicy implements
		BoxManagementPolicy {

	/**
	 * @param box
	 */
	public NextActionsManagementPolicy(Box box) {
		super(box);
	}
