...
/**
 * Box management strategy for trash. Default behavior of {@link AbstractBoxManagementPolicy}
 * @author Marie Acevedo (http://www.sojanddesign.com)
 * @version 28 Jan. 2013 - 0.1
 */
public class TrashManagementPolicy extends AbstractBoxManagementPolicy {

	/**
	 * default constructor
	 */
	TrashManagementPolicy(Box box) {
		super(box);
	}
