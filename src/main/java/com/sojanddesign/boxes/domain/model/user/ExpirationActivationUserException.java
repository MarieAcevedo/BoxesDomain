...
/**
 * TODO ExpirationActivationUserException
 * @author Marie Acevedo (http://www.sojanddesign.com)
 * @version 4 févr. 2013 - 0.1
 */
public class ExpirationActivationUserException extends DomainException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2568225370901042416L;

	/**
	 * 
	 */
	public ExpirationActivationUserException() {
	 ...
	 * @param message
	 */
	public ExpirationActivationUserException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public ExpirationActivationUserException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public ExpirationActivationUserException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
